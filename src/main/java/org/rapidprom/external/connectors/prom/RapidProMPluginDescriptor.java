...
public class RapidProMPluginDescriptor extends AbstractPluginDescriptor {
	...
	public RapidProMPluginDescriptor(Method method, PackageDescriptor pack) throws Exception {
		assert (method != null);
	...
	public RapidProMPluginDescriptor(Class<?> type, Class<? extends PluginContext> acceptedContext, PackageDescriptor pack)
			throws Exception {
		assert (type != null);
	...
	public RapidProMPluginDescriptor(String className, String name, Class<?>[] parTypes, PackageDescriptor pack) throws Exception {
	...
	public boolean equals(Object other) {
		if (!(other instanceof RapidProMPluginDescriptor)) {
			return false;
		}
		RapidProMPluginDescriptor otherDesc = (RapidProMPluginDescriptor) other;
