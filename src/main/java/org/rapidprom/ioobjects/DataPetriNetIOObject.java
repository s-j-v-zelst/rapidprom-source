...
public class DataPetriNetIOObject extends AbstractRapidProMIOObject<DataPetriNet> {
	...
	public DataPetriNetIOObject(DataPetriNet t, Marking i, Marking f, PluginContext context) {
		super(t, context);
		setInitialMarking(i);
		setFinalMarking(f);
	}
	...
	public Marking getInitialMarking() throws ObjectNotFoundException {
		if (initialMarking != null)
			...
			throw new ObjectNotFoundException("There is no initial marking associated with this petri net");
	}
	...
	public void setInitialMarking(Marking marking) {
		...
		if (initialMarking != null)
			this.context.addConnection(new InitialMarkingConnection(this.getArtifact(), initialMarking));
	}
	...
	public Marking getFinalMarking() throws ObjectNotFoundException {
		if (finalMarking != null)
			...
			throw new ObjectNotFoundException("There is no final marking associated with this petri net");
	}
	...
	public void setFinalMarking(Marking marking) {
		...
		if (finalMarking != null)
			this.context.addConnection(new FinalMarkingConnection(this.getArtifact(), finalMarking));
	}
