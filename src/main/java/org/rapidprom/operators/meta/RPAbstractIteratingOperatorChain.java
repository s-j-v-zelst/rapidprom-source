...
*/
package org.rapidprom.operators.meta;
 ...
 */
public abstract class RPAbstractIteratingOperatorChain extends OperatorChain {
	...
	public RPAbstractIteratingOperatorChain(OperatorDescription description) {
		super(description, "RapidProM Iteration");
	...
	protected abstract boolean shouldStop(IOContainer iterationResults) throws OperatorException;
