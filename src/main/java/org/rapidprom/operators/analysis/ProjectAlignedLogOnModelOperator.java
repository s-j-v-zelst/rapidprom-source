...
/**
 * Implements the projection of alignment information on the process model.
 * 
 * @author F. Mannhardt
 *
 */
public class ProjectAlignedLogOnModelOperator extends Operator {
	...
	public ProjectAlignedLogOnModelOperator(OperatorDescription description) {
		super(description);
