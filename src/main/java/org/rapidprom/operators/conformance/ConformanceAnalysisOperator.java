...
public class ConformanceAnalysisOperator extends AbstractRapidProMDiscoveryOperator {
	...
	private static final String WITH_ILP = "ILP Replayer", WITHOUT_ILP = "non-ILP Replayer";
	...
	private OutputPort outputAlignmentTrace = getOutputPorts()
			.createPort("example set with alignment values per trace (Data Table)");
	private OutputPort outputReliable = getOutputPorts()
			.createPort("example set with indicator for reliable traces (Data Table)");
	...
	public ConformanceAnalysisOperator(OperatorDescription description) {
		...
		getTransformer().addRule(new GenerateNewMDRule(outputData, this.metaData));
		// for the alignment
		...
		AttributeMetaData alignAmd2 = new AttributeMetaData(PNRepResult.TRACEFITNESS, Ontology.NUMERICAL);
		...
		AttributeMetaData alignAmd3 = new AttributeMetaData(PNRepResult.MOVELOGFITNESS, Ontology.NUMERICAL);
		...
		AttributeMetaData alignAmd4 = new AttributeMetaData(PNRepResult.MOVEMODELFITNESS, Ontology.NUMERICAL);
		...
		AttributeMetaData alignAmd5 = new AttributeMetaData(PNRepResult.RAWFITNESSCOST, Ontology.NUMERICAL);
		...
		AttributeMetaData alignAmd6 = new AttributeMetaData(PNRepResult.NUMSTATEGENERATED, Ontology.NUMERICAL);
		...
		AttributeMetaData alignAmd111 = new AttributeMetaData(this.TRACEIDENTIFIER, Ontology.STRING);
		...
		AttributeMetaData alignAmd12 = new AttributeMetaData(PNRepResult.TRACEFITNESS, Ontology.NUMERICAL);
		...
		AttributeMetaData alignAmd13 = new AttributeMetaData(PNRepResult.MOVELOGFITNESS, Ontology.NUMERICAL);
		...
		AttributeMetaData alignAmd14 = new AttributeMetaData(PNRepResult.MOVEMODELFITNESS, Ontology.NUMERICAL);
		...
		AttributeMetaData alignAmd15 = new AttributeMetaData(PNRepResult.RAWFITNESSCOST, Ontology.NUMERICAL);
		...
		AttributeMetaData alignAmd16 = new AttributeMetaData(PNRepResult.NUMSTATEGENERATED, Ontology.NUMERICAL);
	...
	public PNRepResult getAlignment(PluginContext pluginContext, PetrinetGraph net, XLog log, Marking initialMarking,
		...
		((CostBasedCompleteParam) parameters).setMaxNumOfStates(getParameterAsInt(PARAMETER_1_KEY) * 1000);
	...
	public List<ParameterType> getParameterTypes() {
		...
		ParameterTypeCategory parameterType0 = new ParameterTypeCategory(PARAMETER_0_KEY, PARAMETER_0_DESCR,
				new String[] { WITH_ILP, WITHOUT_ILP }, 0);
		parameterTypes.add(parameterType0);

		ParameterTypeInt parameterType1 = new ParameterTypeInt(PARAMETER_1_KEY, PARAMETER_1_DESCR, 0, Integer.MAX_VALUE,
				200);
		parameterTypes.add(parameterType1);

		ParameterTypeInt parameterType2 = new ParameterTypeInt(PARAMETER_2_KEY, PARAMETER_2_DESCR, 0, Integer.MAX_VALUE,
				60);
		parameterTypes.add(parameterType2);

		ParameterTypeInt parameterType3 = new ParameterTypeInt(PARAMETER_3_KEY, PARAMETER_3_DESCR, 1, Integer.MAX_VALUE,
	...
	public void fillTraceGroupAlignmentTable(PNRepResult repResult) {
		...
		attributes2.add(AttributeFactory.createAttribute(PNRepResult.TRACEFITNESS, Ontology.NUMERICAL));
		attributes2.add(AttributeFactory.createAttribute(PNRepResult.MOVELOGFITNESS, Ontology.NUMERICAL));
		attributes2.add(AttributeFactory.createAttribute(PNRepResult.MOVEMODELFITNESS, Ontology.NUMERICAL));
		attributes2.add(AttributeFactory.createAttribute(PNRepResult.RAWFITNESSCOST, Ontology.NUMERICAL));
		attributes2.add(AttributeFactory.createAttribute(PNRepResult.NUMSTATEGENERATED, Ontology.NUMERICAL));
	...
	public void fillTraceSingleAlignmentTable(PNRepResult repResult) throws OperatorException {

		// create the third exampleset
		ExampleSet es3 = null;
		MemoryExampleTable table3 = null;
		List<Attribute> attributes3 = new LinkedList<Attribute>();
		attributes3.add(AttributeFactory.createAttribute(this.TRACEINDEX, Ontology.STRING));
		attributes3.add(AttributeFactory.createAttribute(this.TRACEIDENTIFIER, Ontology.STRING));
		attributes3.add(AttributeFactory.createAttribute(PNRepResult.TRACEFITNESS, Ontology.NUMERICAL));
		attributes3.add(AttributeFactory.createAttribute(PNRepResult.MOVELOGFITNESS, Ontology.NUMERICAL));
		attributes3.add(AttributeFactory.createAttribute(PNRepResult.MOVEMODELFITNESS, Ontology.NUMERICAL));
		attributes3.add(AttributeFactory.createAttribute(PNRepResult.RAWFITNESSCOST, Ontology.NUMERICAL));
		attributes3.add(AttributeFactory.createAttribute(PNRepResult.NUMSTATEGENERATED, Ontology.NUMERICAL));
