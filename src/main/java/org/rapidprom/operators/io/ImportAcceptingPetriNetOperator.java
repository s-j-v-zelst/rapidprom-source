...
public class ImportAcceptingPetriNetOperator extends AbstractRapidProMImportOperator<AcceptingPetriNetIOObject> {
	...
	public ImportAcceptingPetriNetOperator(OperatorDescription description) {
		super(description, AcceptingPetriNetIOObject.class, SUPPORTED_FILE_FORMATS);
	}
	...
	protected AcceptingPetriNetIOObject read(File file) throws Exception {
		...
		return new AcceptingPetriNetIOObject(
				AcceptingPetriNetFactory.importFromStream(context, new FileInputStream(file)), context);
	}
