...
//			PARAMETER_4_KEY = "Maximum Remove Probability", PARAMETER_4_DESCR = "The probability of removing any event",
...
//			aux = generator.addNoise(pluginContext, log.getArtifact(), petriNet.getArtifact(),
//					petriNet.getInitialMarking(), petriNet.getFinalMarking(), getParameterAsDouble(PARAMETER_2_KEY),
//					getParameterAsDouble(PARAMETER_3_KEY), getParameterAsDouble(PARAMETER_4_KEY),
...
//				"End: generating noisy event log (" + (System.currentTimeMillis() - time) / 1000 + " sec)");
//	}
//
//	public List<ParameterType> getParameterTypes() {
//		List<ParameterType> parameterTypes = super.getParameterTypes();
//
//		ParameterTypeDouble parameter2 = new ParameterTypeDouble(PARAMETER_2_KEY, PARAMETER_2_DESCR, 0, 1, 0.3);
//		parameterTypes.add(parameter2);
//
//		ParameterTypeDouble parameter3 = new ParameterTypeDouble(PARAMETER_3_KEY, PARAMETER_3_DESCR, 0, 1, 0.3);
//		parameterTypes.add(parameter3);
//
//		ParameterTypeDouble parameter4 = new ParameterTypeDouble(PARAMETER_4_KEY, PARAMETER_4_DESCR, 0, 1, 0.3);
//		parameterTypes.add(parameter4);
//
//		ParameterTypeInt parameter5 = new ParameterTypeInt(PARAMETER_5_KEY, PARAMETER_5_DESCR, 1, 10, 3);
