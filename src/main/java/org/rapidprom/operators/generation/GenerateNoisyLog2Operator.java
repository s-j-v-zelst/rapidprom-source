...
public class GenerateNoisyLog2Operator extends AbstractRapidProMDiscoveryOperator {
	...
	private InputPort inputNet = getInputPorts().createPort("petri net", PetriNetIOObject.class);
	...
	public void doWork() throws OperatorException {
		...
		settings.setProbSwapConsecutiveEvents(getParameterAsDouble(PARAMETER_4_KEY));
		...
		logger.log(Level.INFO,
				"End: generating noisy event log (alf) (" + (System.currentTimeMillis() - time) / 1000 + " sec)");
	}

	public List<ParameterType> getParameterTypes() {
		List<ParameterType> parameterTypes = super.getParameterTypes();

		ParameterTypeBoolean parameter9 = new ParameterTypeBoolean(PARAMETER_9_KEY, PARAMETER_9_DESCR, false);
		parameterTypes.add(parameter9);

		ParameterTypeDouble parameter1 = new ParameterTypeDouble(PARAMETER_1_KEY, PARAMETER_1_DESCR, 0, 1, 0.1);
		parameterTypes.add(parameter1);

		ParameterTypeDouble parameter2 = new ParameterTypeDouble(PARAMETER_2_KEY, PARAMETER_2_DESCR, 0, 1, 0.1);
		parameterTypes.add(parameter2);

		ParameterTypeDouble parameter3 = new ParameterTypeDouble(PARAMETER_3_KEY, PARAMETER_3_DESCR, 0, 1, 0.1);
		parameterTypes.add(parameter3);

		ParameterTypeDouble parameter4 = new ParameterTypeDouble(PARAMETER_4_KEY, PARAMETER_4_DESCR, 0, 1, 0.1);
		parameterTypes.add(parameter4);

		ParameterTypeDouble parameter5 = new ParameterTypeDouble(PARAMETER_5_KEY, PARAMETER_5_DESCR, 0, 1, 0.1);
		parameterTypes.add(parameter5);

		ParameterTypeDouble parameter6 = new ParameterTypeDouble(PARAMETER_6_KEY, PARAMETER_6_DESCR, 0, 1, 0.1);
		parameterTypes.add(parameter6);

		ParameterTypeDouble parameter7 = new ParameterTypeDouble(PARAMETER_7_KEY, PARAMETER_7_DESCR, 0, 1, 0.1);
		parameterTypes.add(parameter7);

		ParameterTypeDouble parameter8 = new ParameterTypeDouble(PARAMETER_8_KEY, PARAMETER_8_DESCR, 0, 1, 0.1);
