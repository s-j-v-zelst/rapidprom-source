...
public class DirectEntropyBasedLogFilterOperator extends Operator {
	...
	public DirectEntropyBasedLogFilterOperator(OperatorDescription description) {
		super(description);
	...
	public void doWork() throws OperatorException {
		...
		DirectEntropyBasedLogFilter filterer = new DirectEntropyBasedLogFilter();
