...
public class GreedyEntropyBasedLogFilterOperator3 extends Operator {
	...
	public GreedyEntropyBasedLogFilterOperator3(OperatorDescription description) {
		super(description);
	...
	public void doWork() throws OperatorException {
		...
		GreedyEntropyBasedLogFilter3 filterer = new GreedyEntropyBasedLogFilter3();
