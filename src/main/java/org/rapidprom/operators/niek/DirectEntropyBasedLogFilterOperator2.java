...
public class DirectEntropyBasedLogFilterOperator2 extends Operator {
	...
	public DirectEntropyBasedLogFilterOperator2(OperatorDescription description) {
		super(description);
	...
	public void doWork() throws OperatorException {
		...
		DirectEntropyBasedLogFilter2 filterer = new DirectEntropyBasedLogFilter2();
