...
public class StaticEventStreamToEventStreamOperator extends Operator {
	...
	private InputPort inputStaticStream = getInputPorts().createPort("static stream",
	...
	public StaticEventStreamToEventStreamOperator(OperatorDescription description) {
		super(description);
	...
	public void doWork() throws OperatorException {
		...
		Object[] authStream = XSStaticXSEventStreamToXSEventStreamPlugin.apply(context,
				inputStaticStream.getData(XSStaticXSEventStreamIOObject.class).getArtifact());
