...
import org.processmining.lpm.postprocess.FilterForDiversification;
...
public class FilterLocalProcessModelRankingForDiversityOperator extends Operator{
	...
	public FilterLocalProcessModelRankingForDiversityOperator(OperatorDescription description) {
		super(description);
	...
	public void doWork() throws OperatorException {
		...
		LocalProcessModelRanking filteredRanking = FilterForDiversification.filterHeadless(input.getData(LocalProcessModelRankingIOObject.class).getArtifact(), getParameterAsDouble(PARAMETER_1_KEY));
